...
<head>
    ...
    <link rel="icon" type="image/png" href="public/storage/assets/img/favicon.png">
    <title>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html "
                target="_blank">
                <img src="{{ asset('/storage/assets/img/logo-ct.png') }}" class="navbar-brand-img h-100"
                    alt="main_logo">
                ...
                <div class="row gx-4">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="{{ asset('/storage/assets/img/bruce-mars.jpg') }}" alt="profile_image"
